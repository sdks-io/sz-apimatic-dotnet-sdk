// <copyright file="FetchResponse.cs" company="APIMatic">
// SeltzApi.Standard
//
...
namespace SeltzApi.Standard.Models
{
    ...
    public class FetchResponse
    {
        ...
        public FetchResponse(
            List<Models.FetchResult> results = null)
        {
            this.additionalProperties = new Dictionary<string, JToken>();
            this.propertyName = this.GetPropertyNames();
        ...
        public List<Models.FetchResult> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"FetchResponse : ({string.Join(", ", toStringOutput)})";
        }
